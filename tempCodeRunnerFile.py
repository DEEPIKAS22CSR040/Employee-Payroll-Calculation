    ...
    if request.method == 'POST':
        ...
        if employee:
            ...
            if salary_data:
                ...
                # Calculate final salary (example logic: deduct for each leave taken)
                final_salary = base_salary - (leaves_taken * deduction_per_leave)  # Define `deduction_per_leave`
                ...
                flash("Error: Role not found for this employee.", "danger")
        else:
